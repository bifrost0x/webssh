...
def test_merged_profile_frontend_assets_have_distinct_cache_versions():
    ...
    expected_versions = {
        ...
        "filename='js/session-workspace.js'": '?v=8',
        "filename='js/session-manager.js'": '?v=9',
        "filename='js/terminal-manager.js'": '?v=9',
